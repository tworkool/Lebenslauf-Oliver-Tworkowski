...
\social[github][www.github.com]{tworkool}
%\extrainfo{Hier können extra Informaitonen stehen.}
\photo[3cm]{abb/Portrait_Oliver_Tworkowski}  %Die Dateiendung wird weggelassen.
...
\begin{document}
	...
	\begin{longtable}[c]{c}
		% DIESE TABELLE WIRD NUR MISSBRAUCHT UM \hiderowcolors ANZUWENDEN
		\hiderowcolors  
	\end{longtable}
	\makecvtitle
...
%	\cventry{2004--2010}{Grundschule}{Merian-Schule}{Berlin}{russisch Unterricht}{}
	...
	\cvlanguage{englisch}{hervorragende Kenntnisse}{Schulunterricht seit der 3. Klasse und bilingualer Unterricht im Gymnasium}
	...
	\cventry{2017--2018}{diverse Minijobs}{}{Berlin}{}{Mehrere Jobs in der Gastronomie Branche und ein Job im Büro}
...
%	\cvcomputer{Office}{Gute Kenntnisse in allen Office Programmen}{Adobe Photoshop}{Hervorragende Kenntnisse}
%	\cvcomputer{LaTeX}{Sehr gute Kenntnisse}{Blender 3D}{Gute Kenntnisse}
%	\cvcomputer{AutoCAD, Inventor}{Sehr gute Kenntnisse}{}{}
%	\subsection{Programmiersprachen}
%	\cvcomputer{LaTeX}{$ \CIRCLE\CIRCLE\CIRCLE\CIRCLE\Circle $}{Java}{}
%	\cvcomputer{C\#}{Sehr gute Kenntnisse}{C++}{Gute Kenntnisse}
%	\cvcomputer{Python}{Hervorragende Kenntnisse}{Kotlin}{Gute Kenntnisse}
%	\cvcomputer{Webentwicklung React JS}{Sehr gute Kenntnisse}{}{}
	
	\section{Hobbys und Interessen}
	\cvlistdoubleitem{Windsurfen}{Ultimate Frisbee}
	\cvlistdoubleitem{Segeln}{Volleyball}
	\cvlistdoubleitem{Videospiele}{Programmieren}
